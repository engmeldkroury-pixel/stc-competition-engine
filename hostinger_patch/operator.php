...
function rulesHtml(competitionId){
 ...
 return '<div class="orderbox"><div class="small">COMPETITION RULES</div>'
  ...
  +'<div class="row"><span>Initial balance</span><span class="value"> const p=snapshot&&snapshot.competition_progress?snapshot.competition_progress[competitionId]:null;
 if(!p)return '';
...
+num(r.initial_balance_usd,2)+'</span></div>'
  +'<div class="row"><span>First prize</span><span class="value"> const p=snapshot&&snapshot.competition_progress?snapshot.competition_progress[competitionId]:null;
 if(!p)return '';
 return '<div class="orderbox"><div class="small">COMPETITION PROGRESS</div>'
  +'<div class="row"><span>Qualifying trading days</span><span class="value">'+esc(p.qualifying_trading_days)+' / '+esc(p.required_trading_days)+'</span></div>'
  +'<div class="row"><span>Days remaining</span><span class="value">'+esc(p.days_remaining)+'</span></div>'
...
+num(r.first_prize_usd,2)+'</span></div>'
