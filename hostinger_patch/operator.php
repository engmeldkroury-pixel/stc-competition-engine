...
function cardHtml(c,i){
 ...
 if(p){
   ticket+='<div class="ticket-grid">'
     ...
     +'<div class="ticket-cell"><div class="ticket-label">RISK</div><div class="ticket-value">'+(c.position_sizing?'
...
+num(c.position_sizing.risk_amount_usd,2):'-')+(riskPct!==null?' • '+num(riskPct,3)+'%':'')+'</div></div>'
     +'</div>'
