...
app = FastAPI(title="STC Competition Engine", version="0.5.0", lifespan=lifespan)


@app.get("/", response_class=HTMLResponse)
def home():
    return """
    <html><head><title>STC v0.5</title></head>
    <body style='font-family:Arial;max-width:900px;margin:40px auto;line-height:1.5'>
    <h1>STC Competition Engine v0.5</h1>
...
@app.get("/health")
def health():
    return {"status": "ok", "version": "0.5.0", "human_approval_required": True}
...
<h1>STC Competition Dashboard <span class='pill'>v0.5</span></h1>
