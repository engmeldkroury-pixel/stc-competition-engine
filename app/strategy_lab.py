...
STRATEGIES: tuple[StrategySpec, ...] = (
    ...
    StrategySpec(
        "adx_ema_trend",
        "TREND",
        "ADX/DMI strength with EMA-stack and trend-state agreement.",
        ("15", "30", "60", "120", "240", "1D"),
        ("trend", "momentum", "market_structure"),
        ("forex", "crypto", "indices", "metals", "energy", "rates"),
    ),
    StrategySpec(
        "donchian_structure_breakout",
        "BREAKOUT",
        "Structure/Donchian breakout confirmed by displacement, volatility and participation.",
        ("15", "30", "60", "120", "240"),
        ("market_structure", "volatility", "volume", "trend"),
        ("forex", "crypto", "indices", "metals", "energy", "rates"),
    ),
    StrategySpec(
        "bollinger_mean_reversion",
        "MEAN_REVERSION",
        "Fade Bollinger/VWAP statistical stretch only when trend strength is suppressed.",
        ("5", "15", "30", "60", "120"),
        ("volatility", "momentum", "vwap", "market_structure"),
        ("forex", "crypto", "indices", "metals", "energy", "rates"),
    ),
    StrategySpec(
        "vwap_reversion",
        "MEAN_REVERSION",
        "Intraday reversion toward session/anchored VWAP in non-trending conditions.",
        ("5", "15", "30", "60"),
        ("vwap", "momentum", "market_structure", "volume"),
        ("forex", "crypto", "indices", "metals", "energy"),
    ),
    StrategySpec(
        "liquidity_sweep_reversal",
        "SMC_REVERSAL",
        "Reverse after a confirmed liquidity sweep with price-action/structure support.",
        ("5", "15", "30", "60", "120"),
        ("smc_liquidity", "market_structure", "price_action", "volume"),
        ("forex", "crypto", "indices", "metals", "energy", "rates"),
    ),
    StrategySpec(
        "failed_breakout_reversal",
        "REVERSAL",
        "Trade rejection after a failed structural breakout with VWAP/price-action confirmation.",
        ("15", "30", "60", "120", "240"),
        ("market_structure", "price_action", "vwap", "smc_liquidity"),
        ("forex", "crypto", "indices", "metals", "energy", "rates"),
    ),
    StrategySpec(
        "fvg_displacement_continuation",
        "SMC_CONTINUATION",
        "Continuation when FVG/imbalance direction agrees with displacement and structure.",
        ("15", "30", "60", "120", "240"),
        ("smc_liquidity", "market_structure", "trend", "volume"),
        ("forex", "crypto", "indices", "metals", "energy"),
    ),
    StrategySpec(
        "volume_confirmed_breakout",
        "BREAKOUT",
        "Structural breakout requiring relative-volume and close-location confirmation.",
        ("5", "15", "30", "60", "120"),
        ("volume", "market_structure", "volatility", "price_action"),
        ("forex", "crypto", "indices", "metals", "energy"),
    ),
)
